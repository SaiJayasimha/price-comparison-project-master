...
class Product(models.Model):
    ...
    price_morrisons = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    price_sainsburys = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    price_tesco = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
